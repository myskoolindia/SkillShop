                                    ...
                                    <td>
                                        ...
                                        <?php if ($transaction->payment_method == 'bank_transfer' && $transaction->payment_status == 'pending_payment'):
                                            ...
                                            if ($showReportButton):?>
                                                ...
                                                <?= view('order/_modal_report_bank_transfer', ['modalBankTransferId' => 'reportBankTransferModal' . $transaction->id, 'reportType' => 'membership', 'reportItemId' => $transaction->id, 'orderNumber' => '']); ?>
                                            <?php endif;
                                        endif; ?>
                                    </td>
