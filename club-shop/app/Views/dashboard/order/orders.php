                            ...
                            foreach ($orders as $item): ?>
                                <tr>
                                    <td class="order-number-table">
                                        <a href="<?= dashboardUrl('order-details/' . $item->id); ?>" class="table-link">
                                    ...
                                    <td>
                                        ...
                                        <a href="<?= base_url('invoice/' . $item->order_number . '?type=seller'); ?>" class="btn btn-sm btn-default" target="_blank"><i class="fa fa-file-text"></i>&nbsp;&nbsp;<?= trans("view_invoice"); ?></a>
                                    </td>
                                        ...
                                        <form action="<?= base_url('OrderAdmin/orderPaymentReceivedPost'); ?>" method="post">
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu options-dropdown" style="min-width: 190px;">
                                                    <li><a href="<?= dashboardUrl('order-details/' . $item->id); ?>"><i class="fa fa-info option-icon"></i><?= trans('view_details'); ?></a></li>
                                                    <?php if ($item->status != 2):
                                                        ...
                                                        <?php endif; ?>
                                                    <?php endif; ?>
                                                    <!-- <li><a href="javascript:void(0)" onclick="deleteItem('OrderAdmin/deleteOrderPost','<?//= $item->id; ?>','<?//= trans("confirm_delete", true); ?>');"><i class="fa fa-trash-can option-icon"></i><?//= trans('delete'); ?></a></li> -->
                                                </ul>
                                            </div>
                                        </form>
                                    </td>
