<div class="box">
    <div class="box-header with-border">
        ...
        <div class="right">
            <a href="<?= langBaseUrl('labelprint/' . esc($order->order_number) . '?type=labelprint'); ?>" target="_blank" class="btn btn-sm btn-info btn-sale-options btn-view-invoice"><i class="fa fa-file-text-o"></i>&nbsp;&nbsp;<?= trans('label_print'); ?></a>
            <a href="<?= langBaseUrl('invoicepos/' . esc($order->order_number) . '?type=seller'); ?>" target="_blank" class="btn btn-sm btn-info btn-sale-options btn-view-invoice"><i class="fa fa-file-text-o"></i>&nbsp;&nbsp;<?= trans('view'); ?> Pos</a>
                                            ...
                                            <div class="table-item-product">
                                                ...
                                                <div class="right">
                                                    ...
                                                    <?php if (!empty($itemSku)): ?>
                                                        <p><span class="span-product-dtl-table"><?= trans("sku"); ?>:</span><b><?= esc($itemSku); ?></b></p>
                                                    <?php endif; ?>
                                            ...
                                            <?php if ($order->status != 2 && $item->order_status != 'refund_approved'):
                                                if ($item->product_type != 'digital'):
                                                    if ($item->order_status == "completed"): ?>
                                                        <strong class="font-600"><i class="fa fa-check"></i>&nbsp;<?= trans("approved"); ?></strong>
                                                    <?php else:
