                                ...
                                if (!empty($sale)):?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <!-- <a href="<?//= generateDashUrl('sale'); ?>/<?//= esc($sale->order_number); ?>" class="btn btn-sm btn-default btn-details"><i class="fa fa-map-pin" aria-hidden="true"></i><?//= trans("address"); ?> <?//= trans("print"); ?></a> -->
                                            <!-- <button class="btn btn-sm btn-default" data-bs-toggle="modal" data-bs-target="#addressModal"
                                                data-order='<?//= json_encode($sale); ?>'> <i class="fa fa-map-pin"></i> <?//= trans("address"); ?> <?//= trans("print"); ?>
                                            </button> -->
