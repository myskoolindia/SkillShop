                        ...
                        <div class="ticket-content">
                            <div class="row">
                                        ...
                                        <?php if (!empty($messages)):
                                            foreach ($messages as $message):
                                                ...
                                                if (!empty($user)):?>
                                                    <li class="media">
                                                        <div class="left">
                                                            <img class="img-profile" src="<?= getUserAvatar($user->avatar, $user->storage_avatar); ?>" alt="" width="48" height="48">
                                                        </div>
                                                        <div class="right">
                                ...
                                <?php if ($refundRequest->status == 0): ?>
                                    <div class="col-sm-12">
                                        <form action="<?= base_url('Order/addRefundMessage'); ?>" method="post">
                                            <?= csrf_field(); ?>
                                            <li class="media">
                                                <input type="hidden" name="id" value="<?= $refundRequest->id; ?>">
                                                <img class="img-profile" width="48" height="48">
                                ...
                                if ($refundRequest->status == 0): ?>
                                    <div class="col-sm-12 text-center">
                                        <form action="<?= base_url('Dashboard/approveDeclineRefund'); ?>" method="post">
                                            <?= csrf_field(); ?>
                                            <input type="hidden" name="id" value="<?= $refundRequest->id; ?>">
