                        ...
                        <?php if (!empty($coupons)):
                            foreach ($coupons as $item): ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?= generateDashUrl('coupon_products'); ?>/<?= $item->id; ?>" class="btn btn-sm btn-primary"><?= trans("select_products"); ?></a>
                                    </td>
                                    <td style="width: 120px;">
                                        <div class="btn-group btn-group-option">
                                            ...
                                            <a href="javascript:void(0)" class="btn btn-sm btn-default btn-delete" data-toggle="tooltip" title="<?= trans('delete'); ?>" onclick='deleteItem("Dashboard/deleteCouponPost","<?= $item->id; ?>","<?= trans("confirm_delete", true); ?>");'><i class="fa fa-trash-can"></i></a>
                                        </div>
                                    </td>
                                </tr>
                            <?php endforeach;
