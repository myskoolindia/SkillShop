                                        ...
                                        if (!empty($product)):?>
                                            <div class="img-table">
                                                <a href="<?= generateProductUrl($product); ?>" target="_blank">
                                                    <img src="<?= getOrderImageUrl($item->product_image_data, $product->id); ?>" data-src="<?= getOrderImageUrl($item->product_image_data, $product->id); ?>" alt="<?= esc($product->title); ?>" class="lazyload img-fluid img-product">
                                                </a>
                                            </div>
