...
<html lang="en">
<head>
    <title><?= $generalSettings->maintenance_mode_title; ?> - <?= $generalSettings->application_name; ?></title>
...
<div class="maintenance">
    <div class="maintenance-inner">
        <div class="content">
            <h1 class="site-title"><?= $generalSettings->application_name; ?></h1>
            <h2 class="title"><?= $generalSettings->maintenance_mode_title; ?></h2>
            <p class="description"><?= $generalSettings->maintenance_mode_description; ?></p>
        </div>
    </div>
</div>
</body>
