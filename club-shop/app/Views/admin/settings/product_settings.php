        ...
        <form action="<?= base_url('Admin/productSettingsPost'); ?>" method="post">
            ...
            <div class="box box-primary">
                ...
                <div class="box-body" style="min-height: 320px;">
                    ...
                    <div class="form-group">
                        <label class="control-label"><?= trans('product_options'); ?></label>
            ...
            <div class="box box-primary">
                ...
                <div class="box-body" style="min-height: 320px;">
                    ...
                    <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <input type="text" id="input_digital_allowed_file_extensions" name="digital_allowed_file_extensions" value="<?= esc(str_replace('"', '', $productSettings->digital_allowed_file_extensions)); ?>" class="form-control tags-input input-tagify">
