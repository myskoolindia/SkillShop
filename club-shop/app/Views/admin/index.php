<?php if (isSuperAdmin()):
    if (is_dir(FCPATH . 'install')): ?>
        <div class="alert alert-danger alert-large m-t-10">
            <strong><i class="fa fa-warning"></i>&nbsp;&nbsp;Security Warning:</strong>&nbsp;&nbsp;The <strong>"install"</strong> folder still exists on your server. Delete it to secure your website!
        </div>
    <?php endif;
    if (file_exists(FCPATH . 'update_database.php')):?>
        <div class="alert alert-danger alert-large m-t-10">
            <strong><i class="fa fa-warning"></i>&nbsp;&nbsp;Security Warning:</strong>&nbsp;&nbsp;The <strong>"update_database.php"</strong> file still exists on your server. Delete it to secure your website!
        </div>
    <?php endif;
endif; ?>
                                ...
                                foreach ($latestReviews as $item): ?>
                                    <tr>
                                        ...
                                        <td style="width: 65%" class="break-word">
                                            ...
                                            <?= esc(characterLimiter($item->review, 100)); ?>
                                            <div class="table-sm-meta"><?= timeAgo($item->created_at); ?></div>
                                        </td>
                                    </tr>
                                <?php endforeach;
                            ...
                            <?php if (!empty($latestComments)):
                                foreach ($latestComments as $item): ?>
                                    <tr>
                                        ...
                                        <td style="width: 65%" class="break-word">
                                            <?= esc(characterLimiter($item->comment, 100)); ?>
                                            <div class="table-sm-meta"><?= timeAgo($item->created_at); ?></div>
                                        </td>
                                    </tr>
                                <?php endforeach;
                                ...
                                foreach ($latestMembers as $item):?>
                                    <li>
                                        <a href="<?= generateProfileUrl($item->slug); ?>">
                                            <img src="<?= getUserAvatar($item->avatar, $item->storage_avatar); ?>" alt="user" class="img-responsive">
                                        </a>
