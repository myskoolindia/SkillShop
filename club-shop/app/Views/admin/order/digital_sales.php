                                    ...
                                    <td>
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu options-dropdown" style="min-width: 190px;">
                                                <li>
                                                    <a href="javascript:void(0)" onclick="deleteItem('OrderAdmin/deleteDigitalSalePost','<?= $item->id; ?>','<?= trans("confirm_delete", true); ?>');"><i class="fa fa-trash-can option-icon"></i><?= trans('delete'); ?></a>
                                                </li>
                                            </ul>
                                        </div>
                                    </td>
