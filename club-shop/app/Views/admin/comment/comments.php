                            ...
                            foreach ($comments as $item): ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        if (!empty($product)): ?>
                                            <a href="<?= generateProductUrl($product); ?>" target="_blank"><?= esc($product->title); ?></a>
                                        <?php endif; ?>
                                    </td>
                                    <td><?= esc($item->ip_address); ?></td>
                                    <td><?= formatDate($item->created_at); ?></td>
                                    <td>
                                        <form action="<?= base_url('Product/approveCommentPost'); ?>" method="post">
                                            <?= csrf_field(); ?>
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu options-dropdown">
                                                    ...
                                                    <?php endif; ?>
                                                    <li><a href="javascript:void(0)" onclick="deleteItem('Product/deleteCommentPost','<?= $item->id; ?>','<?= trans("confirm_comment", true); ?>');"><i class="fa fa-trash-can option-icon"></i><?= trans('delete'); ?></a></li>
                                                </ul>
                                            </div>
                                        </form>
                                    </td>
