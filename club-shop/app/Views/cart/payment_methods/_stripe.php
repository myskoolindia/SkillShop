<?php if (!empty($paymentGateway) && $paymentGateway->name_key == 'stripe' && !empty($stripeCheckoutUrl)): ?>
    <div id="payment-button-container" class="payment-button-cnt">
        ...
        <a href="<?= $stripeCheckoutUrl; ?>" class="btn btn-lg btn-payment" style="background-color: #635BFF; border-color: #635BFF">
