<?php if ($checkout->payment_method == 'bank_transfer'): ?>
    <form action="<?= base_url('checkout/complete-bank-transfer-payment'); ?>" method="post">
        <?= csrf_field(); ?>
        ...
        <div id="payment-button-container" class="payment-button-cnt">
            <h2 class="title-complete-payment"><?= trans("bank_transfer"); ?></h2>

            <div class="bank-account-container text-center m-b-30">
                <?= $paymentSettings->bank_transfer_accounts; ?>
            </div>

            <p class="p-payment-method-description m-b-30"><?= trans("msg_bank_transfer_text"); ?></p>
