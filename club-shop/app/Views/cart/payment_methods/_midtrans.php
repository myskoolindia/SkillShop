<?php if (!empty($paymentGateway) && $paymentGateway->name_key == 'midtrans' && !empty($midtransSnapToken)): ?>
    ...
    <div id="payment-button-container" class="payment-button-cnt">
        ...
        <button type="button" id="btn-midtrans" class="btn btn-lg btn-payment" style="background-color: #054fbf;border-color: #054fbf;">
        ...
        <!-- Loader for AJAX feedback -->
        <div class="payment-loader d-none" style="margin-top: 10px; text-align: center;">
    ...
    <script>
        const configMidtrans = {
            snapToken: "<?= escJs($midtransSnapToken); ?>",
            paymentPostUrl: "<?= base_url('checkout/complete-midtrans-payment'); ?>",
