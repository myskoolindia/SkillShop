<?php if ($checkout->payment_method == 'wallet_balance' && $paymentSettings->wallet_status == 1): ?>
    <form action="<?= base_url('checkout/complete-wallet-balance-payment'); ?>" method="post">
        <?= csrf_field(); ?>
        ...
        <div id="payment-button-container" class="payment-button-cnt">
            ...
            <h2 class="title-complete-payment"><?= trans("wallet_balance"); ?></h2>

            <p class="text-center m-b-30 font-600"><?= trans("pay_wallet_balance_warning"); ?></p>
