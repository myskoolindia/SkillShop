            ...
            <div class="container-invoice">
                <div id="content" class="card">
                    <div class="card-body invoice p-0">
                        ...
                        <div class="row" style="padding: 45px 30px;">
                            ...
                            <div class="col-6">
                                <div class="float-right">
                                    ...
                                    <p class="mb-1"><span style="display: inline-block;min-width: 158px;"><?= trans("payment_status"); ?>:</span><?= $transaction->payment_status == 'pending_payment' ? trans("pending_payment") : trans("payment_received"); ?></p>
                        ...
                        <?php $globalTaxesArray = array();
                        $taxTotal = 0;
                        if (!empty($transaction->global_taxes_data)):
                            $globalTaxesArray = unserializeData($transaction->global_taxes_data);
                            if (!empty($globalTaxesArray)):
                                foreach ($globalTaxesArray as $taxItem) {
                                    if (!empty($taxItem['taxTotal']) && $taxItem['taxTotal'] > 0) {
                                        $taxTotal += $taxItem['taxTotal'];
                                    }
                                }
                            endif;
                        endif; ?>
                            ...
                            <div class="col-12">
                                <div class="order-total float-right">
                                    <div class="row mb-2">
                                        ...
                                        <div class="col-5 col-right">
                                            <?php if (!empty($currency) && $currency->symbol_direction == 'left'): ?>
                                                <strong class="font-600"><?= getCurrencySymbol($transaction->currency); ?><?= $transaction->payment_amount - $taxTotal; ?></strong>
                                            <?php else: ?>
                                                <strong class="font-600"><?= $transaction->payment_amount - $taxTotal; ?><?= getCurrencySymbol($transaction->currency); ?></strong>
                                            <?php endif; ?>
                                        </div>
                                    </div>
                                    <?php if (!empty($transaction->global_taxes_data)):
                                        $globalTaxesArray = unserializeData($transaction->global_taxes_data);
                                        if (!empty($globalTaxesArray)):
                                            foreach ($globalTaxesArray as $taxItem):?>
                                                <div class="row mb-2">
                                                    ...
                                                    <div class="col-5 col-right">
                                                        <strong class="font-600"><?= priceDecimal($taxItem['taxTotal'], $transaction->currency); ?></strong>
                                                    </div>
                                                </div>
                                            <?php endforeach;
                                        endif;
                                    ...
                                    <div class="row mb-2">
                                        ...
                                        <div class="col-5 col-right">
                                            <?php if (!empty($currency) && $currency->symbol_direction == 'left'): ?>
                                                <strong class="font-600"><?= getCurrencySymbol($transaction->currency); ?><?= $transaction->payment_amount; ?></strong>
                                            <?php else: ?>
                                                <strong class="font-600"><?= $transaction->payment_amount; ?><?= getCurrencySymbol($transaction->currency); ?></strong>
                                            <?php endif; ?>
                                        </div>
                                    </div>
                                </div>
